 ...
 * Time: 15:31
 */
echo '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 124 127.1" enable-background="new 0 0 124 127.1" xml:space="preserve">
...
<g>
	...
	<g clip-path="url(#SVGID_4_)">
		<path fill="none" d="M85.2,70.9c0-9.4-5.6-17.4-13.5-21.1V37.8H52.4v12.1c-8,3.7-13.5,11.7-13.5,21.1c0,4.9,1.5,9.4,4.1,13.1h0    c15.4,22.4,15.4,22.4,17,24.8H64c1.6-2.4,1.6-2.4,17-24.8h0C83.6,80.3,85.2,75.8,85.2,70.9z"/>
		<path fill="#FFFFFF" d="M57.4,74.8c0-2.5,2-4.6,4.6-4.6V37.8h-9.6v12.1c-8,3.7-13.5,11.7-13.5,21.1c0,4.9,1.5,9.4,4.1,13.1h0    c15.4,22.4,15.4,22.4,17,24.8h0.3V79.1C58.6,78.4,57.4,76.7,57.4,74.8z"/>
		<path fill="#B1C6D4" d="M85.2,70.9c0-9.4-5.6-17.4-13.5-21.1V37.8H62v32.5c2.5,0,4.6,2,4.6,4.6c0,1.9-1.2,3.5-2.9,4.2v29.8H64    c1.6-2.4,1.6-2.4,17-24.8h0C83.6,80.3,85.2,75.8,85.2,70.9z"/>
		<polygon fill="#D3DEE6" points="60.3,108.9 60.3,109.9 63.7,109.9 63.7,108.9 62,108.9   "/>
		<path fill="#485567" d="M77.7,33H46.2c-3.2,0-5.8,2.6-5.8,5.8V39c0,3.2,2.6,5.8,5.8,5.8h31.5c3.2,0,5.8-2.6,5.8-5.8v-0.1    C83.6,35.6,81,33,77.7,33z"/>
